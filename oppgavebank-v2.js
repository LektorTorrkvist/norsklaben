...
{kat:'og_aa',kat_label:'Og / å',type:'fillsel',vanske:'medium',
 ...
 regel:'«Å» kjem framfor eit verb i infinitiv (å lese, å ete). «Og» bind saman to ord, ledd eller setningar. Test: Byt ut ordet med «å gjere noko» – om det passar, er det «å». Byt ut med «pluss» – om det passar, er det «og».',
...
{kat:'og_aa',kat_label:'Og / å',type:'mc',vanske:'medium',
 ...
 fasit:'vil hjelpe',
 regel:'Etter modalverba «vil», «kan», «skal», «bør», «må» kjem verbet rett i infinitiv – utan «å» og utan «og». Hugseregel: modalverb tek infinitiv direkte.',
 eks:'vil hjelpe · kan gå · skal kome · bør lese · må sove'},
...
{kat:'og_aa',kat_label:'Og / å',type:'fix',vanske:'vanskeleg',
 ...
 regel:'Mange verb og uttrykk styrer infinitiv med «å»: «ha lyst til å», «love å», «prøve å», «bestemme seg for å», «klare å», «gløyme å». Hugseregel: kan du setje inn «det å» framfor? Då er det «å».',
 eks:'hatt lyst å reise · lovde å kome · prøvde å finne · bestemte oss for å dra'},
...
{kat:'og_aa',kat_label:'Og / å',type:'finn_feil',vanske:'medium',
 q:'Klikk på det eine ordet som er feil brukt.',
 tekst:'Læraren bad elevane og lese teksten før prøva.',
 fasit_feil:['og'],
 regel:'Etter «bad nokon» kjem alltid «å + infinitiv»: «bad elevane å lese». «Og» ville berre passa om det band saman to handlingar (t.d. «bad elevane og prøvde sjølv»).',
 eks:'bad oss å hjelpe · bad henne å vente · bad dei å tenkje'},

{kat:'og_aa',kat_label:'Og / å',type:'drag_kolonne',vanske:'medium',
 q:'Sorter: skal det vere «og» eller «å»?',
 kolonner:['Bruk «å»','Bruk «og»'],
 ord:[
  {tekst:'Eg prøvde ___ forstå',fasit:0},
  {tekst:'brød ___ smør',fasit:1},
  {tekst:'Det er viktig ___ sove',fasit:0},
  {tekst:'ho las ___ han skreiv',fasit:1},
  {tekst:'Han byrja ___ gråte',fasit:0},
  {tekst:'mamma ___ pappa',fasit:1}
 ],
 regel:'«Å» står framfor verb i infinitiv (å forstå, å sove, å gråte). «Og» bind saman to ting eller setningar (brød og smør).',
 eks:'prøvde å forstå · brød og smør · byrja å gråte · mamma og pappa'},
...
{kat:'samansett',kat_label:'Samansette ord',type:'mc',vanske:'medium',
 q:'«Lamme lår» i staden for «lammelår» – kva skjer med tydinga?',
 alt:['Same tyding begge måtar','«Lamme lår» blir mat frå lam, «lammelår» blir lamma kroppsdelar','«Lammelår» blir mat (kjøt frå lam); «lamme lår» blir lår som er paralyserte','«Lamme lår» er berre ei gammaldags stavemåte'],
 fasit:'«Lammelår» blir mat (kjøt frå lam); «lamme lår» blir lår som er paralyserte',
 regel:'Særskriving kan endre tydinga heilt. I samansette ord bind orda seg til eitt omgrep; særskrivne blir dei to ord – det første blir gjerne eit adjektiv som skildrar det andre.',
 eks:'lammelår (mat) vs. lamme lår (kroppsdelar utan kraft) · tunfiskbitar (mat) vs. tunfisk bitar (ein fisk som bit)'},
...
{kat:'samansett',kat_label:'Samansette ord',type:'fillsel',vanske:'medium',
 q:'Sett saman orda rett. Skriv som eitt ord når det er samansett.',
 items:[
 ...
 regel:'Samansette ord skriv du i eitt: jordbærsyltethøy, fotballkamp. Men: bruk bindestrek når eitt av ledda er ei forkorting (barne-TV, e-post) eller eit tal (17-åring).',
 eks:'jordbærsyltethøy (ord+ord) · barne-TV (ord+forkorting) · 17-åring (tal+ord)'},

{kat:'samansett',kat_label:'Samansette ord',type:'drag_kolonne',vanske:'vanskeleg',
 q:'Skal det skrivast i eitt ord, eller er det faktisk to ord? Sorter.',
 kolonner:['Eitt ord','To ord'],
 ord:[
  {tekst:'klimaendring',fasit:0},
  {tekst:'sosiale medium',fasit:1},
  {tekst:'ungdomsskule',fasit:0},
  {tekst:'gul farge',fasit:1},
  {tekst:'fotballkamp',fasit:0},
  {tekst:'stor by',fasit:1}
 ],
 regel:'Samansette substantiv = eitt ord (klimaendring, fotballkamp). Adjektiv + substantiv der begge bøyest = to ord (sosiale medium, gul farge, stor by). Test: Kan du setje «veldig» framfor det første ordet? Ja → to ord (veldig gul farge, veldig stor by).',
 eks:'storby (fast omgrep, by av ein viss storleik) vs. stor by (skildring: ein by som er stor)'},
...
{kat:'dobbel_konsonant',kat_label:'Dobbel konsonant',type:'drag_kolonne',vanske:'vanskeleg',
 ...
 regel:'Dobbel konsonant etter kort vokal: stille (kort i), bitter (kort i). Éin konsonant etter lang vokal: liten (lang i), lita (lang i).',
 eks:'stille (kort i → dobbel l) · liten (lang i → éin t) · bitter (kort i → dobbel t)'},
...
{kat:'dobbel_konsonant',kat_label:'Dobbel konsonant',type:'fillsel',vanske:'medium',
 ...
 items:[
  ...
  {pre:'Katten',alt:['søv','søvv'],fasit:'søv',post:'i sofaen.'},
  {pre:'Han',alt:['løper','løpper'],fasit:'løper',post:'fort.'},
  {pre:'Vi',alt:['lagar','laggar'],fasit:'lagar',post:'middag.'}
 ],
 regel:'«Hoppar» (kort o → pp). «Søv» (lang ø → éin v). «Løper» (lang ø → éin p). Kort vokal krev dobbel konsonant; lang vokal gjev enkel konsonant.',
 eks:'hoppar (kort vokal) · søv (lang vokal) · løper (lang vokal) · lagar (lang vokal)'},
...
{kat:'dobbel_konsonant',kat_label:'Dobbel konsonant',type:'sann_usann_serie',vanske:'vanskeleg',
 ...
 paastandar:[
  {tekst:'Etter kort vokal kjem det som hovudregel dobbel konsonant.',sann:true},
 ...
 regel:'Hovudregel: Lang vokal → éin konsonant. Kort vokal → dobbel konsonant. Viktige unntak: korte småord som «han», «men», «som», «vil», «kan», «skal» har éin konsonant sjølv om vokalen er kort.',
 eks:'bil (lang i, éin l) · ball (kort a, dobbel l) · UNNTAK: han, men, vil, kan (éin konsonant likevel)'},

{kat:'dobbel_konsonant',kat_label:'Dobbel konsonant',type:'drag_kolonne',vanske:'lett',
 q:'Sorter orda etter vokallengda – kort eller lang?',
 kolonner:['Kort vokal → dobbel konsonant','Lang vokal → éin konsonant'],
 ord:[
  {tekst:'katt',fasit:0},
  {tekst:'kake',fasit:1},
  {tekst:'ball',fasit:0},
 ...
 regel:'Kort vokal → dobbel konsonant (katt, ball, hatt, sopp). Lang vokal → éin konsonant (kake, bil, hus, sol). Test: Dra vokalen langt når du seier ordet – om det blir rart, er vokalen kort.',
...
{kat:'kj_skj',kat_label:'Kj / skj-lyden',type:'mc',vanske:'lett',
 q:'Kva er rett skrivemåte på eit klesplagg med knappar framme?',
 alt:['skorte','sjorte','skjorte','kjorte'],
 fasit:'skjorte',
 regel:'«Skjorte» skriv du med «skj». Typisk elevfeil: å skrive «sjorte» fordi det høyrest slik ut. Hugs: klesplagg med knappar = skj.',
 eks:'ei kvit skjorte · ei blå skjorte · ei ny skjorte'},
...
{kat:'kj_skj',kat_label:'Kj / skj-lyden',type:'finn_feil',vanske:'medium',
 q:'Klikk på dei to orda som er feil stava.',
 tekst:'Ho tok på seg ei kvit sjorte og skjøpte seg ein kopp varm sjokolade på kjøpesenteret.',
 fasit_feil:['sjorte','skjøpte'],
 regel:'«Skjorte» skriv du med «skj» (klesplagg). «Kjøpte» skriv du med «kj» (preteritum av å kjøpe). «Sjokolade» er korrekt med «sj».',
 eks:'skjorte (skj) · kjøpe/kjøpte (kj) · sjokolade (sj) – kvart ord har sin eigen stavemåte, sjølv om lydane liknar på kvarandre.'},
...
{kat:'teiknsetting',kat_label:'Teiknsetting',type:'mc',vanske:'lett',
 q:'Kva er rett? «Han sa at han var trøytt.»',
 alt:['Han sa, at han var trøytt.','Han sa at han var trøytt.','Han sa: at han var trøytt.','Han sa – at han var trøytt.'],
 fasit:'Han sa at han var trøytt.',
 regel:'På norsk set vi IKKJE komma framfor «at». «At» er eit lite bindeord som innleier ei leddsetning, og setninga flyt utan pause. Same regel gjeld «om», «fordi», «når» når dei står midt i setninga.',
 eks:'Han sa at han var trøytt. · Ho trur at det regnar. · Vi veit at du kjem.'},

{kat:'teiknsetting',kat_label:'Teiknsetting',type:'drag_kolonne',vanske:'medium',
 q:'Treng setninga komma der det er merka med ___?',
 kolonner:['Ja, komma skal stå','Nei, ingen komma'],
 ord:[
  {tekst:'Då eg kom heim ___ laga eg middag.',fasit:0},
  {tekst:'Ho sa ___ at ho kom snart.',fasit:1},
  {tekst:'Vi åt brød ___ ost og mjølk.',fasit:0},
  {tekst:'Eg les ___ og skriv kvar dag.',fasit:1},
  {tekst:'Boka ___ som ho skreiv ___ vart ein suksess.',fasit:0},
  {tekst:'Han kjem ___ fordi han må.',fasit:1}
 ],
 regel:'Komma: etter innleiande leddsetning (Då eg kom heim, …), mellom ledd i oppramsing (brød, ost og mjølk), rundt innskotne leddsetningar (boka, som ho skreiv, …). Ikkje komma: framfor «at», «fordi», «når», «om» som står midt i setninga, eller mellom to verb med same subjekt (les og skriv).',
 eks:'Då eg kom heim, laga eg middag. · Ho sa at ho kom. · Han kjem fordi han må.'},
...
{kat:'ordklassar',kat_label:'Ordklassar',type:'klikk_marker',vanske:'medium',
 q:'Klikk på alle verba i setninga.',
 tekst:'Eleven opna boka, las første avsnitt og skreiv eit samandrag i notatboka si.',
 maalordklasse:'verb',
 fasit_ord:['opna','las','skreiv'],
 regel:'Verb er handlingsord eller tilstandsord. Dei seier kva nokon gjer, tenkjer eller er. Test: Kan du setje «å» framfor ordet og få ei meiningsfull handling? Ja → verb.',
 eks:'opna (å opne) · las (å lese) · skreiv (å skrive) – alle er preteritum av sterke/svake verb.'},

{kat:'ordklassar',kat_label:'Ordklassar',type:'mc',vanske:'vanskeleg',
 q:'Same ordet kan ha ulik ordklasse. Kva er «raskt» i denne setninga? «Ho svarte raskt på e-posten.»',
 alt:['Adjektiv – skildrar «e-posten»','Adverb – skildrar «svarte»','Substantiv – namn på ein ting','Preposisjon – plassord'],
 fasit:'Adverb – skildrar «svarte»',
 regel:'Ordklassen blir bestemt av korleis ordet fungerer i setninga. «Raskt» her skildrar verbet «svarte» (korleis svarte ho?) = adverb. I setninga «ho gav eit raskt svar» skildrar «raskt» substantivet «svar» = adjektiv.',
 eks:'Ho svarte raskt. (adverb – korleis?) · Ho gav eit raskt svar. (adjektiv – kva slags svar?)'},
...
{kat:'setningsbygging',kat_label:'Setningsbygging',type:'fix',vanske:'vanskeleg',
 ...
 regel:'Unngå gjentaking og fyllord. Tre grep for fagleg stil: (1) Bytt ut gjentekne ord med synonym eller overomgrep. (2) Fjern «og sånn», «liksom», «litt». (3) Vel presise fagord i staden for vage ord («bra» → «effektiv», «nyttig», «styrkjande»).',
 eks:'«bra for helsa» → «styrkjer helsa» · «sterkare og sånn» → «betrar kondisjon og muskelstyrke» · «trening er bra» → «regelmessig trening gjev helsegevinst»'},

{kat:'setningsbygging',kat_label:'Setningsbygging',type:'klikk_marker',vanske:'medium',
 q:'Klikk på subjektet i kvar setning. Subjektet er den som gjer handlinga.',
 tekst:'Læraren las teksten. Elevane følgde med. Jonas reiste handa.',
 maalordklasse:'subjekt',
 fasit_ord:['Læraren','Elevane','Jonas'],
 regel:'Subjektet er den personen eller tingen som gjer handlinga i setninga. Test: Spør «kven gjer dette?» – svaret er subjektet.',
 eks:'Læraren las. (kven las? → Læraren) · Elevane følgde med. (kven følgde med? → Elevane)'},

{kat:'setningsbygging',kat_label:'Setningsbygging',type:'drag_ord',vanske:'medium',
 q:'Set orda i rett rekkjefølgje. Hugs V2-regelen når setninga startar med tid eller stad.',
 ord:['I','går','las','eg','heile','boka','.'],
 fasit:'I går las eg heile boka .',
 regel:'V2-regelen: Verbet skal alltid vere det andre leddet i ei norsk hovudsetning. Når setninga startar med eit tidsord eller stadord (I går, Ute, Difor), må verbet likevel kome rett etter – før subjektet.',
 eks:'I går las eg. (ikkje: I går eg las) · Ute snør det. (ikkje: Ute det snør)'},
...
{kat:'bindeord',kat_label:'Bindeord',type:'fillsel',vanske:'vanskeleg',
 ...
 items:[
  ...
  {pre:'Han studerte flittig,',alt:['men','fordi','og'],fasit:'men',post:'strauk han på eksamen.'}
 ],
 regel:'Men = motsetnad mellom to like viktige påstandar. Dessutan = tillegg, noko i same retning. Likevel = kontrast etter ei forventing. Altså = oppsummerande konklusjon (= «med andre ord»). Difor = årsak → verknad.',
 eks:'nyttig, men etiske spørsmål (motsetnad) · øvde, dessutan las teori (tillegg) · studerte, men strauk (uventa utfall) · han øvde, altså kan han det (oppsummering)'},

{kat:'bindeord',kat_label:'Bindeord',type:'drag_ord',vanske:'medium',
 q:'Set orda i rett rekkjefølgje. Hugs V2-regelen.',
 ord:['Difor','gjekk','ho','heim','tidleg','.'],
 fasit:'Difor gjekk ho heim tidleg .',
 regel:'V2-regelen: Verbet skal vere det andre leddet i alle norske hovudsetningar. Når setninga startar med eit framskoten adverbial (difor, i dag, likevel), må verbet kome rett etter – før subjektet.',
 eks:'Difor gjekk ho heim. (ikkje: Difor ho gjekk heim) · Likevel møtte han opp. · I dag kjem dei.'},
...
{kat:'kjeldebruk',kat_label:'Kjeldebruk',type:'sann_usann_serie',vanske:'medium',
 ...
 paastandar:[
  ...
  {tekst:'Ei kjelde frå 2005 er like god som ei frå 2024, uansett tema.',sann:false},
  {tekst:'Det er smart å bruke fleire kjelder som seier det same – då blir argumentet meir truverdig.',sann:true}
 ],
 regel:'Fire kjeldekritiske spørsmål: (1) KVEN er forfattaren – har dei fagleg kompetanse? (2) KVAR er det publisert – forskingsinstitusjon, avis, blogg? (3) NÅR er det skrive – er opplysningane framleis aktuelle? (4) KVIFOR er det skrive – kva er agendaen? Fleire kjelder som seier det same, styrkjer truverdet.',
 eks:'Primærkjelde: NOU-rapport, forskingsartikkel, lovtekst. Sekundærkjelde: avisomtale av ein rapport. Kjeldekritikk er ikkje å avvise – det er å vurdere.'},
...
{kat:'kjeldebruk',kat_label:'Kjeldebruk',type:'mcset',vanske:'vanskeleg',
 q:'Du skal skrive ein fagartikkel om mobilbruk i skulen. Vurder desse kjeldene.',
 tekst:'KJELDE A: Artikkel på bloggen til ein mobilselgar, skriven i 2019, utan forfattarnamn. KJELDE B: Rapport frå Medietilsynet, publisert 2024. KJELDE C: Innlegg frå ei mor på Facebook, skrive i 2023, med 200 likes.',
 questions:[
  {q:'Kva kjelde er truverdig nok for fagartikkelen?',alt:['Berre A','Berre B','Berre C','Alle tre'],fasit:1},
  {q:'Kva er hovudproblemet med kjelde A?',alt:['For gammal','Anonym forfattar og mogleg agenda (mobilselgar)','For kort'],fasit:1},
  {q:'Kva er hovudproblemet med kjelde C?',alt:['For få likes','Personleg meining, ikkje fagleg kjelde','For fersk'],fasit:1}
 ],
 regel:'Ei god fagleg kjelde er: namngitt, publisert av ein institusjon med fagleg kompetanse, og oppdatert nok. Blogg frå nokon som kan ha økonomisk interesse, og private Facebook-innlegg, er ikkje gode fagkjelder – uansett kor mange likes dei har.',
 eks:'Truverdige fagkjelder: Medietilsynet, FHI, SSB, Lesesenteret, forsking.no, fagfellevurderte tidsskrift. Mindre truverdige: blogg, sosiale medium, anonyme nettstader.'},

{kat:'kjeldebruk',kat_label:'Kjeldebruk',type:'fix',vanske:'medium',
 q:'Rett dei tre kjeldetilvisingsfeila.',
 tekst:'Ein studie viser at ungdom les mindre (nrk). Ifølgje forsking er dette urovekkjande. Medietilsynet skriv i artikkelen sin at skjermtida har auka (Medietilsynet, 2024, artikkel på nett).',
 errors:{'(nrk)':'(NRK, 2024)','Ifølgje forsking er dette urovekkjande':'Ifølgje Lesesenteret (2023) er dette urovekkjande','(Medietilsynet, 2024, artikkel på nett)':'(Medietilsynet, 2024)'},
 fasit:'(NRK, 2024) · Ifølgje Lesesenteret (2023) … · (Medietilsynet, 2024)',
 regel:'Standardformat for kjeldetilvising: (Namn, årstal). NRK skal ha stor bokstav. Vage kjelder som «forsking» treng eit konkret namn. Ekstra informasjon i parentesen («artikkel på nett», «side 5») høyrer heime i kjeldelista, ikkje i teksten.',
 eks:'Rett: (SSB, 2023) · (Medietilsynet, 2024) · (Lesesenteret, 2023). Feil: (nrk), (ein artikkel eg las), (forsking)'},
...
{kat:'sjangerkompetanse',kat_label:'Sjangerkompetanse',type:'mc',vanske:'lett',
 q:'Kva kjenneteiknar eit debattinnlegg – i motsetnad til ein fagartikkel?',
 alt:[
  'Nøytral framstilling utan eiga meining (som i fagartikkel)',
  'Klar meining, argument for og mot, og eit tydeleg standpunkt',
  'Berre fakta utan vurdering (som i referat)',
  'Ingen kjeldetilvisingar – berre personleg erfaring'
 ],
 fasit:'Klar meining, argument for og mot, og eit tydeleg standpunkt',
 regel:'Eit debattinnlegg argumenterer for eit standpunkt, brukar retoriske verkemiddel og avsluttar med ei oppmoding. Hovudskilnaden frå fagartikkelen er at du MÅ ta stilling. Men du bør likevel bruke kjelder og saklege argument – ein god debatt er ikkje berre kjensler.',
 eks:'Påstand → argument for (med kjelder) → motargument → tilbakevising → konklusjon/oppmoding'},

{kat:'sjangerkompetanse',kat_label:'Sjangerkompetanse',type:'mcset',vanske:'vanskeleg',
 q:'Les dette tekstutdraget frå ein elev og svar.',
 tekst:'Mobilen er eit problem i skulen. Elevane mine bruker for mykje tid på han. Forsking frå Medietilsynet (2024) viser at ungdom bruker i snitt tre timar dagleg på sosiale medium. Difor bør vi forby mobil heilt i skuletida.',
 questions:[
  {q:'Kva sjanger passar best til denne teksten?',alt:['Fagartikkel','Debattinnlegg','Novelle'],fasit:1},
  {q:'Kva element frå debatt er tydeleg?',alt:['Dialog','Påstand + oppmoding','Spenningskurve'],fasit:1},
  {q:'Kva manglar for at det skal vere ein god fagartikkel?',alt:['Standpunktet må takast bort, teksten må vere nøytral','Spenningskurva må byggjast opp','Teksten må skrivast i fortid'],fasit:0}
 ],
 regel:'Teksten har både sakleg innhald (kjeldebruk) og tydeleg standpunkt (forby heilt). Kombinasjonen gjer det til eit debattinnlegg, ikkje ein fagartikkel. Ein fagartikkel hadde presentert problemet utan å konkludere politisk.',
 eks:'Debattinnlegg: påstand + kjelder + oppmoding. Fagartikkel: same kjelder, men presenterer fleire sider og lar lesaren trekkje konklusjonen.'},

{kat:'sjangerkompetanse',kat_label:'Sjangerkompetanse',type:'omskriv',vanske:'vanskeleg',
 q:'Teksten nedunder er skriven i fagartikkelstil. Skriv om til eit debattinnlegg – behald fakta, men legg til standpunkt, retorikk og oppmoding.',
 tekst:'Ungdom bruker i snitt tre timar dagleg på sosiale medium (Medietilsynet, 2024). Forsking frå FHI (2023) viser at mykje skjermtid kan henge saman med søvnproblem og auka stress.',
 instruksjon:'Legg til: (1) eit tydeleg standpunkt tidleg i teksten, (2) minst eitt retorisk verkemiddel (spørsmål, direkte tiltale, gjentaking), (3) ei oppmoding til lesaren eller til styresmaktene.',
 regel:'Fagartikkel → debatt: same fakta, men fleire grep. Du må ta stilling, bruke retorikk og peike på kva som må gjerast. Kjeldene gjer argumenta truverdige også i debatt.',
 eks:'Forslag: «Skal vi late ungdommen brenne ut før dei er ferdige på skulen? Tre timar dagleg på sosiale medium (Medietilsynet, 2024) – det er meir enn dei brukar på lekser. FHI (2023) viser at det kostar dei søvn og livskvalitet. Skulane må handle no.»'},
...
{kat:'fagartikkel',kat_label:'Fagartikkel',type:'fix',vanske:'medium',
 ...
 regel:'Tre grep for fagleg språk: (1) Erstatt «alle veit»/«det er klart» med kjeldebaserte formuleringar («forsking viser», «studiar tyder på»). (2) Fjern personlege meiningsmarkørar («eg synest/trur») – lat kjeldene tale. (3) Bytt kjensleord («dust», «ekstremt») med saklege vurderingar («problematisk», «alvorleg»).',
 eks:'«alle veit» → «studiar tyder på» · «eg synest» → «fleire forskarar peikar på» · «dust» → «problematisk»'},
...
{kat:'fagartikkel',kat_label:'Fagartikkel',type:'fillsel',vanske:'lett',
 ...
 regel:'Fagartikkelspråk gjenkjenner du på tre teikn: (1) KJELDER – «Forsking viser», «Ifølgje SSB», ikkje «alle seier». (2) NØYTRAL TONE – ingen slang, ingen overdrivingar, ingen emojiar. (3) PRESISJON – konkrete tal, ikkje «mega mykje», «sinnsjukt».',
 eks:'«Forsking viser …» (kjelde) · «Ifølgje SSB …» (kjelde) · «12 % auke» (presisjon) · «Det hastar å finne …» (nøytral)'},
...
{kat:'fagartikkel',kat_label:'Fagartikkel',type:'cloze',vanske:'lett',
 ...
 hint:'Eit ord som viser til ei namngitt kjelde. Både «ifølgje» (eitt ord) og «ifølge» er korrekt nynorsk – men ikkje «i følgje» (to ord, som tyder «i reisefølgje med»).',
 fasit:'Ifølgje',fasit_v:['Ifølgje','ifølgje','Ifølge','ifølge','I følgje','I følge'],
 regel:'«Ifølgje» brukast for å vise til ei kjelde. Merk: på norsk skal det skrivast i eitt ord. «I følgje» (to ord) tyder noko anna: «vere i følgje med nokon». Typiske kjeldetilvisingsord: ifølgje, som nemnt av, basert på, dokumentert av.',
 eks:'Ifølgje SSB (2024) · Som nemnt av Medietilsynet (2024) · Basert på tal frå FHI (2023)'},
...
{kat:'fagartikkel',kat_label:'Fagartikkel',type:'drag_kolonne',vanske:'medium',
 q:'Sorter: Kva setningar er påstandar som tåler ein fagartikkel?',
 kolonner:['OK i fagartikkel – dokumenterbar','Problematisk – treng kjelde eller omskriving'],
 ord:[
  {tekst:'Ifølgje SSB (2023) les 60 % av ungdom bøker dagleg.',fasit:0},
  {tekst:'Alle veit at ungdom les for lite.',fasit:1},
  {tekst:'Medietilsynet (2024) rapporterer at skjermtida har auka med 40 minutt sidan 2020.',fasit:0},
  {tekst:'Det er heilt openbert at mobilen øydelegg konsentrasjonen.',fasit:1},
  {tekst:'Forsking ved UiO tyder på ein samanheng mellom søvn og skjermbruk.',fasit:0},
  {tekst:'Dei fleste meiner at skulen må forby mobilar.',fasit:1}
 ],
 regel:'I fagartikkel må påstandar tole nærlesing. Kjeldebaserte påstandar («Ifølgje SSB», «Forsking tyder på») står støtt. Udokumenterte påstandar («alle veit», «det er openbert», «dei fleste meiner») gjer teksten mindre truverdig – du må anten finne ei kjelde, eller formulere om til noko du faktisk kan dokumentere.',
 eks:'DOKUMENTERBAR: «Ifølgje SSB (2023) les 60 %…» · PROBLEMATISK: «alle veit», «det er openbert», «dei fleste meiner»'},
...
{kat:'debattinnlegg',kat_label:'Debattinnlegg',type:'cloze',vanske:'lett',
 ...
 hint:'Eit verb som tyder å be nokon om å handle – typisk i avslutninga av eit debattinnlegg.',
 fasit:'oppmodar',fasit_v:['oppmodar','oppfordrar','ber','krev'],
 regel:'Eit debattinnlegg sluttar gjerne med ei oppmoding – eit verb som ber lesaren om å handle. Vanlege val: oppmodar (høfleg), oppfordrar (litt sterkare), ber (nøytralt), krev (sterkt). Vel styrke etter saka – «krev» er for sterkt for små saker.',
 eks:'«Vi oppmodar politikarane til å …» (mild) · «Vi oppfordrar styresmaktene om å …» (fast) · «Vi krev at …» (aggressiv, brukast sparsamt)'},

{kat:'debattinnlegg',kat_label:'Debattinnlegg',type:'finn_feil',vanske:'vanskeleg',
 q:'Klikk på dei to formuleringane som er usaklege eller personangrep.',
 tekst:'Vi treng betre skulebibliotek. Forsking viser at lesing styrkjer ordforrådet. Ministeren som er imot dette, har aldri forstått kor viktig lesing er. Ho er ein inkompetent politikar. Difor må kommunen auke budsjettet.',
 fasit_feil:['Ho er ein inkompetent politikar','har aldri forstått kor viktig lesing er'],
 regel:'Eit godt debattinnlegg argumenterer mot saka, ikkje mot personen. Personangrep («ho er inkompetent») og nedlatande påstandar om motstandaren («har aldri forstått») svekkjer argumentasjonen din – lesaren mistar tillit. Gode grep: vis kva ministeren faktisk har sagt, og argumenter mot dei konkrete argumenta.',
 eks:'USAKLEG: «Ministeren er inkompetent.» SAKLEG: «Ministeren har hevda at digital lesing er nok, men forsking (Lesesenteret, 2023) viser at papirbøker gir betre konsentrasjon.»'},

{kat:'debattinnlegg',kat_label:'Debattinnlegg',type:'mcset',vanske:'medium',
 q:'Les dette debattinnlegget og svar på spørsmåla.',
 tekst:'Mobilforbod er vegen å gå. Elevane mine er konstant distraherte. Forsking frå Universitetet i Stavanger (2023) viser at mobilforbod aukar konsentrasjonen med 15 %. Somme vil seie at mobilen er nødvendig for tryggleik, men skulane har telefonar for dette. Difor må vi innføre mobilforbod på ungdomsskulen.',
 questions:[
  {q:'Kva er standpunktet i teksten?',alt:['Mobilen bør vere frivillig','Mobilforbod er nødvendig','Elevane er distraherte'],fasit:1},
  {q:'Kva retorisk grep blir brukt i andre setning?',alt:['Kjeldetilvising','Personleg erfaring (etos)','Motargument'],fasit:1},
  {q:'Korleis blir motargumentet handsama?',alt:['Ikkje nemnt','Nemnt og tilbakevist','Nemnt og støtta'],fasit:1}
 ],
 regel:'Eit godt debattinnlegg har: tydeleg standpunkt, minst eitt argument med kjelde (logos), personleg erfaring eller autoritet (etos), eit motargument som blir tilbakevist, og ei oppmoding.',
 eks:'Sjekk: Standpunkt (ja) + Kjelde (ja: UiS 2023) + Etos (ja: «mine elevar») + Motargument handsama (ja) + Oppmoding (ja: «må innføre»).'},
...
{kat:'overskrift_ingress',kat_label:'Overskrift og ingress',type:'fillsel',vanske:'medium',
 ...
 regel:'Ei god overskrift passar til sjangeren: FAGARTIKKEL = tema + antydning om funn («Isbreane smeltar – raskare enn nokon gong»). DEBATTINNLEGG = standpunkt eller oppmoding («Leksene må bort!»). Unngå ordet «Om» – det er nesten alltid tom. Spørsmålsforma fungerer i fagartiklar for å skape nysgjerrigheit.',
 eks:'Fagartikkel (temp + funn): «Isbreane smeltar …» · Debatt (standpunkt): «Leksene må bort …» · Fagartikkel (spørsmål): «Kvifor søv ungdom for lite?»'},

{kat:'overskrift_ingress',kat_label:'Overskrift og ingress',type:'omskriv',vanske:'medium',
 q:'Lag ei betre overskrift og ingress til ein fagartikkel om plast.',
 tekst:'Min artikkel. Denne teksten handlar om plast. Plast er over alt og det er ganske ekkelt eigenleg.',
 instruksjon:'Skriv ei overskrift (ca. 4-10 ord) og ein ingress (1-2 setningar). Overskrifta skal vere presis og fengande. Ingressen skal gi lesaren hovudfunna med éin gong.',
 regel:'Overskrift: presis + fengande + fortel temaet. Unngå intetsigande titlar («Min artikkel», «Om plast»). Ingress: saklege hovudfunn med konkret tal eller poeng som gjer lesaren nysgjerrig. Unngå slang og vage formuleringar.',
 eks:'Overskrift-forslag: «Plast i havet – ein trussel mot livet under vatn» / «Mikroplast i maten: Kva skjer med helsa vår?» / «Kvart år hamnar 8 millionar tonn plast i havet». Ingress-forslag: «Kvart år hamnar millionar tonn plast i havet. Ny forsking viser korleis det truar heile næringskjeda.»'},

{kat:'overskrift_ingress',kat_label:'Overskrift og ingress',type:'mc',vanske:'vanskeleg',
 q:'Kva overskrift fungerer BEST for ein fagartikkel om søvn og ungdom, og kvifor?',
 alt:[
  '«Søvn» – fordi ho er kort og enkel',
  '«Ungdom søv for lite – kva gjer det med hjernen?» – fordi ho har tema, funn og eit spørsmål som vekkjer nysgjerrigheit',
  '«Om søvn hos ungdom» – fordi ho seier nøyaktig kva teksten handlar om',
  '«Søvn er jo viktig!!!» – fordi ho er fengande'
 ],
 fasit:'«Ungdom søv for lite – kva gjer det med hjernen?» – fordi ho har tema, funn og eit spørsmål som vekkjer nysgjerrigheit',
 regel:'Ei god fagartikkel-overskrift har tre element: (1) TEMA – kva handlar teksten om? (2) VINKEL – kva er hovudfunnet eller spørsmålet? (3) FENGSEL – noko som får lesaren til å ville lese meir. «Søvn» manglar vinkel og fengsel. «Om søvn» har berre tema. «Søvn er jo viktig!!!» manglar fagleg vinkel og bruker utropsteikn som høyrer heime i tabloidaviser, ikkje fagtekstar.',
 eks:'Mønster: [Tema] + [Vinkel/funn] + [Spørsmål eller dashstrek]. Døme: «Plast i havet – ein stille katastrofe» eller «Kvifor les ungdom mindre bøker?»'},
...
{kat:'novelle',kat_label:'Novelle',type:'mc',vanske:'medium',
 q:'Kva er «in medias res»?',
 alt:[
  'Å starte forteljinga midt i hendinga',
  'Å skrive novella i første person',
  'Å ha ei overraskande slutt',
  'Å bruke dialogar i staden for skildring'
 ],
 fasit:'Å starte forteljinga midt i hendinga',
 regel:'«In medias res» (latin for «midt i saka») er eit klassisk novellegrep: starte rett inn i handlinga, utan lang innleiing. Lesaren får raskt forstå kven og kva, og blir dregen inn i stemninga. Motsetninga er å starte med lang bakgrunn – noko novellesjangeren sjeldan tillèt på grunn av lengda.',
 eks:'In medias res: «Ho slo opp døra og skreik.» Ikkje-in-medias-res: «Det var ein fredag i november, og Anna var seks år gammal då ho …» (for mykje bakgrunn).'},

{kat:'novelle',kat_label:'Novelle',type:'drag_kolonne',vanske:'medium',
 q:'Kva grep høyrer heime i novella, og kva i fagteksten?',
 kolonner:['Novellegrep','Fagtekstgrep'],
 ord:[
  {tekst:'Skildring av stemning og miljø',fasit:0},
  {tekst:'Kjeldetilvising i parentes',fasit:1},
  {tekst:'Dialog som avslører karakteren',fasit:0},
  {tekst:'Statistikk og prosenttal',fasit:1},
  {tekst:'Frampek mot noko som skal skje',fasit:0},
  {tekst:'Nøytral, sakleg tone',fasit:1},
  {tekst:'Vending som endrar alt',fasit:0},
  {tekst:'Logiske argument med grunngjeving',fasit:1}
 ],
 regel:'Novelle viser og antyder (skildringar, dialog, frampek, vending). Fagtekst forklarer og dokumenterer (kjelder, tal, argument, nøytral tone). Ein novelle utan skildring blir flat; ein fagtekst med skildring blir uprofesjonell.',
 eks:'NOVELLE: «Regnet sila mot vindauget. Ho heldt kaffekoppen hardare.» FAGTEKST: «Nedbøren i Noreg auka med 18 % frå 2010 til 2023 (Meteorologisk institutt, 2024).»'},

{kat:'novelle',kat_label:'Novelle',type:'omskriv',vanske:'vanskeleg',
 q:'Skriv om dette referatet til opninga av ei novelle. Bruk in medias res, skildring og frampek.',
 tekst:'Jonas gjekk på skulen. Han hadde gløymt matpakka. Han vart sur på mora si. Seinare den dagen fekk han tilbod om lunsj av ein ny elev.',
 instruksjon:'Kutt «Jonas gjekk på skulen» – start midt i ei hending. Bruk skildring (kva ser, høyrer, luktar Jonas?). Gi eit frampek om noko som skal skje.',
 regel:'Ei god novelleopning har tre grep: (1) In medias res – ikkje start med introduksjon. (2) Skildring – visuelle, konkrete detaljar som gir stemning. (3) Frampek – eit hint om at noko skal skje eller endre seg.',
 eks:'Forslag: «Jonas rota i sekken tredje gong. Matpakka var der ikkje. Magen knurra, klokka var berre ti over ni, og resten av dagen strekte seg framføre han som ein ørken. Ingen visste endå at dette skulle bli ein av dei dagane han seinare kom til å hugse.»'},
...
{kat:'parafrase',kat_label:'Parafrase',type:'drag_kolonne',vanske:'lett',
 ...
 regel:'Tre kategoriar: (1) PARAFRASE – dine ord + kjeldetilvising. (2) SITAT – kjelda sine ord + hermeteikn + kjelde. (3) PLAGIAT – kjelda sine ord utan hermeteikn og/eller utan kjelde. Viktig: Det er IKKJE plagiat å bruke nokre av dei same fagorda («fysisk aktivitet», «barn») – plagiat er å overta kjernen i formuleringa utan å gje kreditt.',
 eks:'Parafrase: «Born rører seg mindre (FHI, 2023).» Sitat: «…minka med 20 prosent» (FHI, 2023). Plagiat: «Fysisk aktivitet blant barn har minka med 20 %» (utan kjelde = stolen formulering).'},
...
{kat:'parafrase',kat_label:'Parafrase',type:'omskriv',vanske:'vanskeleg',
 q:'Skriv om originalteksten med dine eigne ord. Hugs å behalde kjelda.',
 tekst:'Ungdom bruker i gjennomsnitt tre timer daglig på sosiale medier (Medietilsynet, 2024).',
 instruksjon:'Skriv om med eigne ord og ny setningsstruktur. Behald kjelda (Medietilsynet, 2024). Unngå å kopiere heile frasar frå originalen.',
 maa_ha:['Medietilsynet'],
 regel:'Ein god parafrase endrar både ordval og setningsstruktur, ikkje berre eitt og anna ord. Du kan godt bruke nokre av dei same fagorda («sosiale medium», «ungdom»), men heilskapen må vere omformulert.',
 eks:'Forslag til omformulering: «Medietilsynet (2024) rapporterer at norske ungdomar i snitt tilbringer tre timar dagleg på sosiale plattformer.» Merk: kjelda er bevart, orda er omforma, setningsstrukturen er ny.'},
...
{kat:'parafrase',kat_label:'Parafrase',type:'omskriv',vanske:'vanskeleg',
 ...
 instruksjon:'Skriv om med eigne ord og ny setningsstruktur. Behald kjelda (FHI, 2023). Unngå å kopiere heile frasar frå originalen.',
 maa_ha:['FHI'],
 regel:'Ein god parafrase endrar både ordval og setningsstruktur, ikkje berre eitt og anna ord. Du kan godt bruke nokre av dei same fagorda («fysisk aktivitet», «born»), men heilskapen må vere omformulert.',
 eks:'Forslag til omformulering: «Ifylgje FHI (2023) har born og unge rørt seg ein femtedel mindre enn for ti år sidan.» Merk: kjelda er bevart, talet er omskrive («ein femtedel» i staden for «20 prosent»), setningsstrukturen er ny.'},
...
{kat:'sitat',kat_label:'Sitat og sitatbruk',type:'mcset',vanske:'vanskeleg',
 ...
 regel:'Tre typar gjengiving: (1) DIREKTE SITAT – ordrett, i hermeteikn, med kjelde: «…» (Kjelde, årstal). (2) INDIREKTE SITAT – «sa at / skriv at / meiner at» + omforma innhald + kjelde. (3) PARAFRASE – eigne ord + kjelde. Alle tre krev kjeldetilvising. Direkte sitat MÅ ha hermeteikn – utan er det plagiat.',
 eks:'Direkte: «Plasten truar livet» (FN, 2022). Indirekte: FN skriv at plasten trugar livet (FN, 2022). Parafrase: Havet er i fare på grunn av plastforureining (FN, 2022).'},

{kat:'sitat',kat_label:'Sitat og sitatbruk',type:'fix',vanske:'vanskeleg',
 q:'Rett dei tre sitatfeila i teksten.',
 tekst:'Forskaren sa at: «Klimaendringane er dramatiske». Medietilsynet skriv: Ungdom brukar tre timar dagleg på mobil (2024). Ein rapport meiner «plastproblemet er alvorleg», (WWF, 2023).',
 errors:{'sa at: «Klimaendringane er dramatiske»':'sa: «Klimaendringane er dramatiske» (Hansen, 2024)','Medietilsynet skriv: Ungdom brukar tre timar dagleg på mobil (2024)':'Medietilsynet (2024) skriv at ungdom brukar tre timar dagleg på mobil','«plastproblemet er alvorleg», (WWF, 2023)':'«plastproblemet er alvorleg» (WWF, 2023)'},
 fasit:'sa: «Klimaendringane er dramatiske» (Hansen, 2024) · Medietilsynet (2024) skriv at ungdom brukar … · «plastproblemet er alvorleg» (WWF, 2023)',
 regel:'Tre vanlege sitatfeil: (1) «sa at» + hermeteikn – bland ikkje direkte og indirekte sitat. Bruk «sa:» før direkte sitat, eller «sa at» før indirekte. (2) Manglande hermeteikn – direkte sitat må alltid ha « ». (3) Feil komma/punktum-plassering – kjeldetilvising står etter sitatet, utan komma framfor parentesen.',
 eks:'Direkte: Hansen sa: «Klimaendringane er dramatiske» (Hansen, 2024). Indirekte: Hansen sa at klimaendringane er dramatiske (Hansen, 2024).'},

{kat:'sitat',kat_label:'Sitat og sitatbruk',type:'drag_kolonne',vanske:'medium',
 q:'Sorter: Kva type gjengiving er kvar setning?',
 kolonner:['Direkte sitat','Indirekte sitat','Parafrase'],
 ord:[
  {tekst:'«Plast er den største trugselen mot havlivet» (WWF, 2023).',fasit:0},
  {tekst:'WWF (2023) seier at plast er den største trugselen mot havlivet.',fasit:1},
  {tekst:'Havforureining er blitt den alvorlegaste risikofaktoren for marint dyreliv (WWF, 2023).',fasit:2},
  {tekst:'«Ungdom les 30 % mindre enn for ti år sidan» (SSB, 2023).',fasit:0},
  {tekst:'SSB (2023) rapporterer at lesetala hos ungdom har gått ned.',fasit:1},
  {tekst:'Lesevanar blant unge har endra seg dramatisk det siste tiåret (SSB, 2023).',fasit:2}
 ],
 regel:'Direkte sitat: Ordrett, i hermeteikn. Indirekte sitat: «sa at / skriv at / meiner at» + omforma innhald. Parafrase: Heilt eigne ord, men same innhald. Alle treng kjeldetilvising.',
 eks:'Direkte: «Plast er trugsel» (WWF, 2023). Indirekte: WWF seier at plast er ein trugsel. Parafrase: Plastforureining er kritisk (WWF, 2023).'},
...
{kat:'tal_og_statistikk',kat_label:'Tal og statistikk',type:'mc',vanske:'medium',
 ...
 regel:'PROSENT (%) er ein del av eit heile – «60 % av ungdom les». PROSENTPOENG er differansen mellom to prosenttal. Hugseregel: Viss talet i seg sjølv har ei eining (%), så er endringa i prosentpoeng. Viss talet er noko anna (kroner, folketal), så er endringa i prosent. Typisk elevfeil: å blande desse.',
 eks:'Frå 40 % til 60 % = 20 prosentpoeng (ikkje 20 %). Frå 40 kr til 60 kr = auke med 50 % (ikkje 20 kr er 50 %). Frå 40 % til 60 % er også ein auke på 50 % i relativ forstand (men dette skriv ein sjeldan i fagtekst – det skaper forvirring).'},

{kat:'tal_og_statistikk',kat_label:'Tal og statistikk',type:'mc',vanske:'vanskeleg',
 q:'Lesetala på skule X gjekk frå 60 % til 90 % mellom 2018 og 2024. Kva er ein korrekt måte å beskrive endringa på?',
 alt:[
  'Auka med 30 %',
  'Auka med 30 prosentpoeng',
  'Halvert',
  'Tredobla'
 ],
 fasit:'Auka med 30 prosentpoeng',
 regel:'Når ein samanliknar to prosenttal, er differansen alltid prosentpoeng. Viss du vil seie «auka med 30 %», må du spesifisere kva 30 % er av. 30 % av 60 % ville vore 18 (altså frå 60 til 78, ikkje frå 60 til 90). Den relative auken frå 60 til 90 er 50 %, ikkje 30 %. For å unngå forvirring: bruk prosentpoeng for skilnad, og ver forsiktig med relative prosent når opphavstalet også er eit prosenttal.',
 eks:'60 % → 90 % = 30 prosentpoeng · Den relative auken: (90-60)/60 = 50 % · IKKJE «auka med 30 %» – det er misvisande.'},
...
{kat:'tal_og_statistikk',kat_label:'Tal og statistikk',type:'fillsel',vanske:'medium',
 ...
 regel:'Tre reglar for tal i fagtekst: (1) DIFFERANSE mellom prosenttal = prosentpoeng (aldri prosent). (2) PROPORSJON av eit heile = prosent. (3) DOBLING, TREDOBLING eller HALVERING er presise verb som lesaren forstar umiddelbart – bruk dei framfor «auka med 100 %». Unngå vage uttrykk som «ganske mange», «nesten alle», «litt over halvparten» – kom med konkrete tal med kjelde.',
 eks:'15 prosentpoeng (differanse) · 96 % (proporsjon) · dobla seg (klår endring) · ikkje «ganske mange» eller «veldig få»'},
...
{kat:'tal_og_statistikk',kat_label:'Tal og statistikk',type:'drag_kolonne',vanske:'medium',
 q:'Sorter: Er tallbruken presis og kjeldefesta, eller upresis?',
 kolonner:['Presis og kjeldefesta','Upresis eller udokumentert'],
 ord:[
  {tekst:'Ifølgje SSB (2023) har forbruket auka med 12 %.',fasit:0},
  {tekst:'Ganske mange ungdomar les lite.',fasit:1},
  {tekst:'Frå 2010 til 2023 auka talet frå 45 % til 60 % – ein auke på 15 prosentpoeng (Medietilsynet, 2023).',fasit:0},
  {tekst:'Veldig mange er på sosiale medium no for tida.',fasit:1},
  {tekst:'Talet på røykjarar er halvert sidan 2000 (FHI, 2023).',fasit:0},
  {tekst:'Lesetala har gått ned ei god stund.',fasit:1}
 ],
 regel:'Presis talbruk har tre element: (1) konkret tal, (2) kjeldetilvising, (3) tidsramme. Vage uttrykk som «ganske mange», «veldig mange», «ei god stund» fortel lesaren ingenting – og fjernar truverdet.',
 eks:'PRESIS: «12 % auke (SSB, 2023)» · VAGT: «ganske mange»'},
...
{kat:'samansett',kat_label:'Samansette ord',type:'fix',vanske:'medium',
 ...
 regel:'Samansette substantiv skriv du alltid som eitt ord på norsk. Hugseregel: Uttal ordet høgt. Høyrer du det som eitt omgrep (trykk berre på første del)? Då skriv du det saman. «UNGdomsskule» = eitt trykk = eitt ord. «ungdoms SKULE» = to trykk = feil.',
 eks:'ungdomsskule (ung+dom+skule) · bokkveld (bok+kveld) · kulturhus (kultur+hus) · bollesal (bolle+sal)'},

{kat:'dobbel_konsonant',kat_label:'Dobbel konsonant',type:'fix',vanske:'medium',
 q:'Rett dei tre feila med einskild og dobbel konsonant.',
 ...
 errors:{'katen':'katten','Balen':'Ballen','nata':'natta'},
 fasit:'katten · Ballen · natta',
 regel:'Etter kort vokal skriv du dobbel konsonant: katt (kort a → tt), ball (kort a → ll), natt (kort a → tt). Hugseregel: les ordet høgt og lytt. Kort trykk på vokalen = dobbel konsonant.',
 eks:'katt (kort a) · ball (kort a) · natt (kort a) · SAMANLIKN: gut/guten har lang u → éin t'},
...
/* --- og/å rett teksten (10 lengre oppgåver) --- */
{kat:'og_aa',kat_label:'Og / å',type:'fix',vanske:'medium',
 q:'Rett dei 5 og/å-feila i teksten.',
 tekst:'Læraren bad oss om og lese teksten og svare på spørsmåla. Eg prøvde og konsentrere meg, men det var vanskeleg og leggje merke til detaljane. Maria og Jonas klarte og bli ferdige først, og dei fekk lov til og gå ut i friminuttet.',
 errors:{'om og lese':'om å lese','prøvde og konsentrere':'prøvde å konsentrere','vanskeleg og leggje':'vanskeleg å leggje','klarte og bli':'klarte å bli','lov til og gå':'lov til å gå'},
 fasit:'om å lese · prøvde å konsentrere · vanskeleg å leggje · klarte å bli · lov til å gå',
 regel:'«Å» er infinitivsmerke og står framfor verb. Test: set inn «for» framfor – passar det? Då er det «å».',
...
{kat:'og_aa',kat_label:'Og / å',type:'fix',vanske:'medium',
 ...
 regel:'Etter hjelpeverb og uttrykk som «pleier», «forsøkte», «umogleg» brukar vi «å» + verb.',
 eks:'pleier å reise · forsøkte å reparere · umogleg å finne'},

{kat:'og_aa',kat_label:'Og / å',type:'fix',vanske:'vanskeleg',
 q:'Rett dei 6 og/å-feila i teksten. Pass på: fleire «og» er riktige!',
 tekst:'Det er viktig og hugse og gjere leksene sine. Morten og Ane bestemde seg for og starte ei lesegruppe og hjelpe kvarandre. Dei byrja og møtast kvar tysdag og torsdag, og etter kvart klarte dei og forbetre resultata sine monaleg.',
 errors:{'viktig og hugse':'viktig å hugse','hugse og gjere':'hugse å gjere','for og starte':'for å starte','og hjelpe kvarandre':'å hjelpe kvarandre','byrja og møtast':'byrja å møtast','klarte dei og forbetre':'klarte dei å forbetre'},
 fasit:'viktig å hugse · hugse å gjere · for å starte · å hjelpe kvarandre · byrja å møtast · klarte dei å forbetre',
 regel:'«Å» står framfor verb (infinitiv). «Og» bind saman ord eller setningar. Mange feil oppstår der begge kan «høyrast riktige ut».',
 eks:'viktig å hugse å gjere · bestemde seg for å starte · byrja å møtast'},

{kat:'og_aa',kat_label:'Og / å',type:'fix',vanske:'medium',
 q:'Rett dei 4 og/å-feila i teksten.',
 tekst:'Eleven ønskte og skrive ein god tekst og imponere læraren. Ho brukte tid og energi på og finne gode kjelder, og klarte til slutt og levere ein tekst ho var stolt av.',
 errors:{'ønskte og skrive':'ønskte å skrive','og imponere læraren':'å imponere læraren','på og finne':'på å finne','klarte til slutt og levere':'klarte til slutt å levere'},
 fasit:'ønskte å skrive · å imponere · på å finne · klarte til slutt å levere',
 regel:'Framfor verb brukar vi «å». «Og» bind saman ting eller setningar, ikkje verb i infinitiv.',
 eks:'ønskte å skrive · brukte tid på å finne'},

{kat:'og_aa',kat_label:'Og / å',type:'fix',vanske:'vanskeleg',
 q:'Rett dei 5 og/å-feila. Teksten har også mange riktige «og» – ikkje endre dei!',
 tekst:'Trening handlar om og pushe seg sjølv og bli betre. Lars og Emilie trenar styrke og kondisjon tre gonger i veka. Dei har lært og varme opp skikkeleg, og dei hugsar alltid og tøye ut etterpå. Trenaren har bede dei om og føre treningsdagbok.',
 errors:{'om og pushe':'om å pushe','og bli betre':'å bli betre','lært og varme':'lært å varme','hugsar alltid og tøye':'hugsar alltid å tøye','om og føre':'om å føre'},
 fasit:'om å pushe · å bli betre · lært å varme · hugsar alltid å tøye · om å føre',
 regel:'Etter uttrykk som «handlar om», «har lært», «hugsar», «bede om» brukast alltid «å» + verb.',
 eks:'handlar om å pushe · har lært å varme opp · hugsar å tøye ut'},

{kat:'og_aa',kat_label:'Og / å',type:'fix',vanske:'medium',
 q:'Rett dei 3 og/å-feila i teksten.',
 tekst:'Vi vart samde om og dele oppgåvene mellom oss. Nokre skulle lage mat og andre skulle dekkje bordet og rydde. Det var lett og bli samde, men vanskelegare og faktisk gjennomføre planen. Til slutt fekk vi det til og hadde ein fin kveld.',
 errors:{'om og dele':'om å dele','lett og bli':'lett å bli','vanskelegare og faktisk':'vanskelegare å faktisk'},
 fasit:'om å dele · lett å bli · vanskelegare å faktisk',
 regel:'Etter «samde om», «lett» og «vanskeleg» brukast «å» + verb.',
 eks:'samde om å dele · lett å bli samde · vanskeleg å gjennomføre'},

{kat:'og_aa',kat_label:'Og / å',type:'fix',vanske:'vanskeleg',
 q:'Rett dei 5 og/å-feila i denne avisartikkel-teksten.',
 tekst:'Kommunen planlegg og byggje ein ny skule og eit nytt bibliotek. Målet er og gje elevane betre fasilitetar og tilgang til moderne teknologi. Foreldre og lærarar har bede politikarane om og prioritere prosjektet og sikre finansiering. Dei håpar og kunne starte bygginga allereie neste år.',
 errors:{'planlegg og byggje':'planlegg å byggje','er og gje':'er å gje','om og prioritere':'om å prioritere','og sikre finansiering':'å sikre finansiering','håpar og kunne':'håpar å kunne'},
 fasit:'planlegg å byggje · er å gje · om å prioritere · å sikre · håpar å kunne',
 regel:'Framfor verb i infinitiv brukast «å». «Og» bind saman ting (skule og bibliotek) eller setningsledd.',
 eks:'planlegg å byggje · målet er å gje · håpar å kunne starte'},

{kat:'og_aa',kat_label:'Og / å',type:'fix',vanske:'medium',
 q:'Rett dei 4 og/å-feila i teksten.',
 tekst:'Katten og hunden lever fredeleg saman. Dei har lært og respektere kvarandre og dele matskålene. Eigaren pleier og mate dei morgon og kveld, og ho gløymer aldri og gje dei ferskt vatn.',
 errors:{'lært og respektere':'lært å respektere','og dele matskålene':'å dele matskålene','pleier og mate':'pleier å mate','gløymer aldri og gje':'gløymer aldri å gje'},
 fasit:'lært å respektere · å dele · pleier å mate · gløymer aldri å gje',
 regel:'Etter verb som «har lært», «pleier», «gløymer» brukast «å» + infinitiv.',
 eks:'har lært å respektere · pleier å mate · gløymer å gje'},

{kat:'og_aa',kat_label:'Og / å',type:'fix',vanske:'vanskeleg',
 q:'Rett dei 6 og/å-feila. Ver nøye – mange «og» er riktige!',
 tekst:'Regjeringa oppmodar folk og bedrifter til og spare straum og redusere forbruket. Det er mogleg og gjere kvardagen meir miljøvenleg utan og ofre komfort. Ein kan byrje med og skru av lys og apparat som ikkje er i bruk, og gradvis venje seg til og bruke mindre energi.',
 errors:{'til og spare':'til å spare','og redusere forbruket':'å redusere forbruket','mogleg og gjere':'mogleg å gjere','utan og ofre':'utan å ofre','med og skru':'med å skru','til og bruke':'til å bruke'},
 fasit:'til å spare · å redusere · mogleg å gjere · utan å ofre · med å skru · til å bruke',
 regel:'Etter preposisjonar som «til», «utan», «med» + verb brukast alltid «å». «Og» bind saman substantiv (folk og bedrifter, lys og apparat).',
 eks:'oppmodar til å spare · utan å ofre · byrje med å skru av'},

{kat:'og_aa',kat_label:'Og / å',type:'fix',vanske:'medium',
 q:'Rett dei 4 og/å-feila i teksten.',
 tekst:'Elevane fekk beskjed om og jobbe stille og konsentrert. Dei fleste klarte og følgje instruksane, men nokre syntest det var kjedeleg og sitje stille så lenge. Læraren lovde og gje dei ein pause om dei jobba bra, og det motiverte heile klassen.',
 errors:{'om og jobbe':'om å jobbe','klarte og følgje':'klarte å følgje','kjedeleg og sitje':'kjedeleg å sitje','lovde og gje':'lovde å gje'},
 fasit:'om å jobbe · klarte å følgje · kjedeleg å sitje · lovde å gje',
 regel:'Etter verb og uttrykk som «fekk beskjed om», «klarte», «syntest det var kjedeleg», «lovde» brukast «å» + verb.',
 eks:'beskjed om å jobbe · klarte å følgje · lovde å gje'},
...
{kat:'teiknsetting',kat_label:'Teiknsetting',type:'fillsel',vanske:'medium',
 q:'Set inn rett teikn i kvar setning.',
 items:[
 ...
 regel:'Komma etter innleiande leddsetning eller framskoten adverbial. Kolon før direkte tale med hermeteikn. Komma mellom ledd i oppramsing. IKKJE komma framfor «at».',
 eks:'Når timen var ferdig, pakka elevane saman. · Læraren sa: «De må levere.» · Ho tok med penn, notatbok og vassflaske.'},
...
{kat:'teiknsetting',kat_label:'Teiknsetting',type:'fillsel',vanske:'medium',
 ...
 items:[
  ...
  {pre:'Læraren spurde elevane',alt:[':',',','.'],fasit:':',post:'«Har de brukt kjelder?»'},
  {pre:'Når du siterer',alt:[',',';','.'],fasit:',',post:'må du oppgje kjelde.'}
 ],
 regel:'Spørsmål får ?, utrop får !, utsegner får punktum. Komma etter innleiande leddsetning. Kolon før direkte tale. IKKJE komma framfor «at» eller «om» som innleier leddsetning.',
 eks:'Korleis kan vi forbetre innleiinga? · Læraren spurde: «Har de brukt kjelder?» · Når du siterer, må du oppgje kjelde.'},
...
{kat:'djupneoppgaver',kat_label:'Djupneoppgåver',type:'open',vanske:'vanskeleg',
 ...
 hint:'Ta med minst eitt konkret døme, eitt motargument og ei kort avslutting. Det finst ingen fasit – bygg di eiga grunngjevne refleksjon.',
 regel:'Bygg resonnering med tydeleg påstand, grunngjeving og nyansering. Bruk fagomgrep og presise overgangar. Hugs: oppgåva ber om refleksjon, ikkje einvege argumentasjon.',
 ...
 eks:'Kriterier for eit godt reflekterande avsnitt: (1) ein tydeleg hovudpåstand, (2) minst eitt konkret døme (t.d. frå skulen, frå eigen mobilbruk), (3) eit motargument eller ei nyansering, (4) ei avslutting som samlar poenga. Bruk ord som «samstundes», «likevel», «difor», «på den andre sida».'},

{kat:'djupneoppgaver',kat_label:'Djupneoppgåver',type:'open',vanske:'vanskeleg',
 q:'Skriv eit drøftande miniinnlegg (10-30 min): Bør kunstig intelligens vere tillate i norsk skriftleg arbeid?',
 hint:'Presenter minst to argument for og to mot. Grunngjev kvart argument konkret. Trekk ein eigen konklusjon til slutt – det finst ingen fasit på kva du skal meine.',
 regel:'Ei god drøfting viser fleire perspektiv før du konkluderer. Bruk koplingsord som «på den eine sida», «samstundes», «likevel» og «difor». Argument må grunngjevast – ikkje berre listast.',
 eksempel_svak:'KI kan vere bra, men også litt dumt. Eg synest det kjem an på.',
 eksempel_god:'På den eine sida kan KI støtte elevar i idéfasen og i omarbeiding av tekst. På den andre sida kan ukritisk bruk svekkje skriveutviklinga og kjeldekritikken. Her må ein vege nytte mot risiko og sjå på korleis skulen kan regulere bruken. [Her trekkjer du di eiga grunngjevne konklusjon.]',
 eks:'Kriterier for ei god drøfting: (1) minst to argument på kvar side, (2) konkrete døme frå skulekvardagen, (3) motargument som blir tilbakevist eller nyansert, (4) ein eigen konklusjon som følgjer av argumenta du har presentert.'},

{kat:'djupneoppgaver',kat_label:'Djupneoppgåver',type:'open',vanske:'medium',
 q:'Skriv eit motargument til påstanden: «Ungdom i dag les mindre enn før, og det er eit stort problem for samfunnet.»',
 hint:'Eit motargument skal ikkje berre nekte påstanden – det skal vise ein annan måte å tenkje på. Prøv å finne noko som er sant, men som nyanserer biletet.',
 regel:'Eit godt motargument (1) tek påstanden på alvor, (2) viser eit perspektiv som ikkje er med i påstanden, (3) bruker konkrete døme eller kjelder for å vere truverdig.',
 eksempel_svak:'Eg er ikkje einig. Ungdom les mykje, dei les berre andre ting.',
 eksempel_god:'Det stemmer at ungdom les færre bøker no enn før, men definisjonen av «lesing» har også endra seg. Ungdomar les mykje kvar dag – på sosiale medium, i meldingar og i spel. Spørsmålet er om all denne teksten har same læringsverdi som lange bøker, eller om det er ein annan type lesekompetanse som no blir viktig.',
 eks:'Kriterier: (1) motargumentet tek utgangspunkt i påstanden, (2) det legg fram eit nytt perspektiv, (3) det bruker konkrete døme, (4) det er formulert saklig – ikkje berre som uenig.'},

{kat:'djupneoppgaver',kat_label:'Djupneoppgåver',type:'open',vanske:'medium',
 q:'Skriv ei innleiing (3-5 setningar) til ein fagartikkel om skjermtid og ungdom.',
 hint:'Ei god innleiing gjer tre ting: (1) vekkjer interesse, (2) presenterer temaet, (3) varslar kva teksten skal handle om.',
 regel:'Ei fagleg innleiing skal ikkje avsløre heile svaret, men gjere lesaren nysgjerrig. Unngå klisjéar som «I dag skal eg skrive om …». Prøv å starte med eit overraskande tal, eit konkret døme, eit spørsmål eller ein påstand som inviterer til undring.',
 eksempel_svak:'I denne teksten skal eg skrive om skjermtid. Det er eit stort tema. Mange bruker skjerm mykje.',
 eksempel_god:'Norske 13-åringar brukar i snitt fem timar dagleg på skjerm – meir enn dei søv på ein vanleg kveld. Er dette eit reelt problem, eller har vi berre fått ei ny form for fritid? Spørsmålet fortener eit nyansert svar.',
 eks:'Kriterier: (1) ein innleiing skal ikkje konkludere, (2) ho skal gje lesaren ein grunn til å halde fram, (3) presentere tema utan å avsløre alt, (4) bruke eit konkret grep (tal, døme, spørsmål) for å fange merksemda.'},

/* ═══════════════════════════════════════════════════
   OG / Å  –  «Rett i teksten»  (8 oppgåver)
   Tekstane har BÅDE riktige og-konstruksjonar OG
   infinitivsfeil, slik at eleven må vurdere kvar inst.
   ═══════════════════════════════════════════════════ */
{kat:'og_aa',kat_label:'Og / å',type:'fix',vanske:'lett',
 q:'Rett dei to og/å-feila i teksten.',
 tekst:'Mora og barna bestemte seg for og ta ein tur i skogen. Det var viktig og kome seg ut, og alle likte å gå på tur.',
 errors:{'for og ta':'for å ta','viktig og kome seg':'viktig å kome seg'},
 fasit:'for å ta · viktig å kome seg',
 regel:'Etter preposisjonen «for» og adjektivet «viktig» brukes «å» + infinitiv. «Og» bind «mora og barna» – det er riktig.',
 eks:'bestemte seg for å ta · viktig å kome seg ut'},

{kat:'og_aa',kat_label:'Og / å',type:'fix',vanske:'lett',
 q:'Rett dei to og/å-feila i teksten.',
 tekst:'Han prøvde og lage mat, men det blei ikkje bra. Søstera og mamma hjelpte til, og dei klarte og redde middagen.',
 errors:{'prøvde og lage':'prøvde å lage','klarte og redde':'klarte å redde'},
 fasit:'prøvde å lage · klarte å redde',
 regel:'«Å» etter verb som «prøve» og «klare»: dei styrer infinitiv. «Og» mellom «søstera og mamma» er bindeord – riktig.',
 eks:'prøvde å lage mat · klarte å redde middagen'},

{kat:'og_aa',kat_label:'Og / å',type:'fix',vanske:'medium',
 q:'Rett dei tre og/å-feila i teksten.',
 tekst:'Klassen og læraren bestemte seg for og halde ein debatt om skulematen. Elevane fekk høve til og seie meiningane sine, og læraren freista og få alle til å delta.',
 errors:{'for og halde':'for å halde','til og seie':'til å seie','freista og få':'freista å få'},
 fasit:'for å halde · til å seie · freista å få',
 regel:'Etter «for», «til» og verb som «freiste» brukes «å» + infinitiv. «Klassen og læraren» – bindeord ✓.',
 eks:'for å halde debatt · høve til å seie · freista å få'},

{kat:'og_aa',kat_label:'Og / å',type:'fix',vanske:'medium',
 q:'Rett dei tre og/å-feila i teksten.',
 tekst:'Barne- og ungdomsteateret inviterte elevar og lærarar til og sjå ei ny framsyning. Det var spanande og viktig og oppleve teater, og alle fekk høve og skrive melding etterpå.',
 errors:{'til og sjå':'til å sjå','viktig og oppleve':'viktig å oppleve','høve og skrive':'høve å skrive'},
 fasit:'til å sjå · viktig å oppleve · høve å skrive',
 regel:'«Til», «viktig» og «høve» styrer infinitiv med «å». «Elevar og lærarar» er bindeord – riktig.',
 eks:'til å sjå · viktig å oppleve · høve å skrive'},

{kat:'og_aa',kat_label:'Og / å',type:'fix',vanske:'medium',
 q:'Rett dei fire og/å-feila i teksten.',
 tekst:'Politikarane ønskjer og satse meir på fornybar energi og kutte utsleppa. Det er viktig og handle raskt, sidan sol og vindkraft allereie er kostnadseffektive løysingar. Ingen parti vågar og ta rekninga åleine, og nokre er villige til og inngå kompromiss.',
 errors:{'ønskjer og satse':'ønskjer å satse','viktig og handle':'viktig å handle','vågar og ta':'vågar å ta','til og inngå':'til å inngå'},
 fasit:'ønskjer å satse · viktig å handle · vågar å ta · til å inngå',
 regel:'«Ønskjer», «viktig», «våge» og «til» styrer infinitiv med «å». «Energi og kutte» er to parallelle infinitivar – «og» er bindeord der.',
 eks:'ønskjer å satse · viktig å handle raskt · til å inngå kompromiss'},

{kat:'og_aa',kat_label:'Og / å',type:'fix',vanske:'medium',
 q:'Rett dei fire og/å-feila. Teksten inneheld mange riktige «og».',
 tekst:'Elevane og læraren diskuterte berekraft. Dei ønskte og lage ein presentasjon og vise funna for resten av skulen. Det var krevjande og samle god informasjon og kjeldefeste alt. Alle gleda seg til og presentere, og nokre håpa og vekkje interesse hos medelevar.',
 errors:{'ønskte og lage':'ønskte å lage','krevjande og samle':'krevjande å samle','til og presentere':'til å presentere','håpa og vekkje':'håpa å vekkje'},
 fasit:'ønskte å lage · krevjande å samle · til å presentere · håpa å vekkje',
 regel:'Etter «ønske», «krevjande», «til» og «håpe» brukes «å». «Og vise», «og kjeldefeste» er parallelle infinitivar – «og» er bindeord.',
 eks:'ønskte å lage · krevjande å samle · til å presentere'},
...
{kat:'og_aa',kat_label:'Og / å',type:'fix',vanske:'vanskeleg',
 q:'Rett dei fem og/å-feila. Ver særleg nøye med preposisjonar.',
 tekst:'Veljarane og politikarane er samde om og sørgje for eit trygt og rettferdig samfunn. Unge er ivrige etter og påverke politikken, og dei har rett til og delta i den demokratiske prosessen. Det er mogleg og engasjere seg i mange parti og organisasjonar. Politikarane bør freiste og representere alle grupper og lytte til innbyggjarane.',
 errors:{'om og sørgje':'om å sørgje','etter og påverke':'etter å påverke','til og delta':'til å delta','mogleg og engasjere':'mogleg å engasjere','freiste og representere':'freiste å representere'},
 fasit:'om å sørgje · etter å påverke · til å delta · mogleg å engasjere · freiste å representere',
 regel:'Etter «om», «etter», «til», «mogleg» og verb som «freiste» brukes «å». «Og lytte» er riktig – det bind to parallelle verb etter «bør».',
 eks:'samde om å sørgje · ivrig etter å påverke · rett til å delta'},

/* ═══════════════════════════════════════════════════
   DOBBEL KONSONANT  –  «Rett i teksten»  (6 oppgåver)
   Tekstane har korrekte enkelt- og dobbeltkonsonantar
   i tillegg til feila, slik at eleven må vurdere.
   ═══════════════════════════════════════════════════ */
{kat:'dobbel_konsonant',kat_label:'Dobbel konsonant',type:'fix',vanske:'lett',
 q:'Rett dei to rettskrivingsfeila.',
 tekst:'Vi sat rundt bordet og åt midag. Etter middagen gjekk eg ut og leika med balen i hagen.',
 errors:{'midag':'middag','balen':'ballen'},
 fasit:'middag · ballen',
 regel:'Kort vokal → dobbel konsonant. «Middag» har kort i (m-i-d-d). «Ball» har kort a (b-a-l-l). «Middagen» seinare er rett – sjå korleis ordet skal skrivast.',
 eks:'middag (kort i → dd) · ball (kort a → ll)'},

{kat:'dobbel_konsonant',kat_label:'Dobbel konsonant',type:'fix',vanske:'lett',
 q:'Rett dei to rettskrivingsfeila i teksten.',
 tekst:'Katten sate seg i vindaugskarmen og stirra ut på gata. Det var nata til jul, og det låg snø i hagen.',
 errors:{'sate':'sette','nata':'natta'},
 fasit:'sette · natta',
 regel:'Preteritum av «å setje» er «sette» (kort e → tt). «Natt» har kort a → tt i bøying. «Gate» og «hage» har lang vokal → enkel konsonant.',
...
{kat:'dobbel_konsonant',kat_label:'Dobbel konsonant',type:'fix',vanske:'medium',
 ...
 fasit:'sette · hoppa',
 regel:'«Setje» → «sette» (kort e). «Hoppe» → «hoppa» i nynorsk preteritum (kort o → pp).',
 eks:'å setje → sette · å hoppe → hoppa'},

{kat:'dobbel_konsonant',kat_label:'Dobbel konsonant',type:'fix',vanske:'medium',
 q:'Rett dei to rettskrivingsfeila i teksten.',
 tekst:'Mange ungdomar er opptekne av trening. Dei hoppar og spring for å halde seg i form, og nokre tek seg ein kop kaffi etterpå. Koppen er gjerne liten, men smaken er god.',
 errors:{'ungdomar':'ungdommar','kop':'kopp'},
 fasit:'ungdommar · kopp',
 regel:'«Ungdom» + «-ar» → «ungdommar» (kort o → mm). «Kopp» har kort o → pp.',
...
{kat:'dobbel_konsonant',kat_label:'Dobbel konsonant',type:'fix',vanske:'vanskeleg',
 ...
 regel:'Kort vokal → dobbel konsonant. Sjå nøye etter kvar vokalen er kort.',
 eks:'katt (kort a → tt) · å hoppe → hoppa · å setje → sette'},

{kat:'dobbel_konsonant',kat_label:'Dobbel konsonant',type:'fix',vanske:'vanskeleg',
 q:'Rett dei fire rettskrivingsfeila i teksten.',
 tekst:'Heile klassen sate seg ned då læraren kom inn. Nokre ungdomar fniste stille, men dei fleste opna bøkene. Læraren drakk ein kop kafé og byrja timen med å lese høgt frå ein roman.',
 errors:{'sate':'sette','ungdomar':'ungdommar','kop':'kopp','kafé':'kaffi'},
 fasit:'sette · ungdommar · kopp · kaffi',
 regel:'«setje» → «sette», «ungdom» → «ungdommar», «kopp» (kort o), «kaffi» (kort a).',
 eks:'å setje → sette · ungdom → ungdommar · kopp (kort o) · kaffi (kort a)'},

/* ═══════════════════════════════════════════════════
   KJELDEBRUK  –  «Rett i teksten»  (6 oppgåver)
   Elevtekstar med feil kjeldebruk – nokre element er
   rette, andre må rettast.
   ═══════════════════════════════════════════════════ */
{kat:'kjeldebruk',kat_label:'Kjeldebruk',type:'fix',vanske:'lett',
 q:'Rett dei to kjeldebruksfeila i teksten.',
 tekst:'Plastforureining er eit alvorleg miljøproblem. Heile åtte millionar tonn plast hamnar i havet kvart år. (Jensen, 2023). Forskaren skriv: Vi er i ferd med å øydelegge havet for framtidige generasjonar (Jensen, 2023, s. 4).',
 errors:{'kvart år. (Jensen, 2023).':'kvart år (Jensen, 2023).','skriv: Vi er i ferd med å øydelegge havet for framtidige generasjonar':'skriv: «Vi er i ferd med å øydelegge havet for framtidige generasjonar»'},
 fasit:'Kjeldetilvising flyttast foran punktum · Direkte sitat i hermeteikn',
 regel:'Kjeldetilvising (Forfattar, årstal) kjem alltid FØR punktum. Direkte sitat skal stå i «hermeteikn».',
 eks:'... kvart år (Jensen, 2023). · «Ordrett sitat» (Kjelde, årstal).'},

{kat:'kjeldebruk',kat_label:'Kjeldebruk',type:'fix',vanske:'lett',
 q:'Rett dei to kjeldebruksfeila i teksten.',
 tekst:'Mange unge slit med psykisk helse (fhi.no). Solvang skriv: Unge jenter er den gruppa som opplever mest press (Solvang, 2024, s. 22). Tidleg innsats er ifølgje forsking det viktigaste tiltaket.',
 errors:{'(fhi.no)':'(FHI, 2024)','Solvang skriv: Unge jenter er den gruppa som opplever mest press':'Solvang skriv: «Unge jenter er den gruppa som opplever mest press»'},
 fasit:'(fhi.no) → (FHI, 2024) · Direkte sitat i hermeteikn',
 regel:'Bruk (Forfattar/institusjon, årstal) – ikkje URL. Direkte sitat markerast alltid med «hermeteikn».',
 eks:'(FHI, 2024) ikkje (fhi.no) · «Ordrett tekst» (Kjelde, årstal).'},

{kat:'kjeldebruk',kat_label:'Kjeldebruk',type:'fix',vanske:'medium',
 q:'Rett dei to kjeldebruksfeila i teksten.',
 tekst:'Klimaendringar er ei av vår tids største utfordringar (Kari Jensen, 2023). Jensen konkluderer med at: Vi er nøydde til å handle innan 2030, elles er det for seint (Jensen, 2023, s. 15). Det er brei semje om dette blant forskarar.',
 errors:{'(Kari Jensen, 2023)':'(Jensen, 2023)','Jensen konkluderer med at: Vi er nøydde til å handle innan 2030, elles er det for seint':'Jensen konkluderer med at: «Vi er nøydde til å handle innan 2030, elles er det for seint»'},
 fasit:'(Kari Jensen, 2023) → (Jensen, 2023) · Direkte sitat i hermeteikn',
 regel:'I løpande tekst brukes berre etternamn + årstal: (Jensen, 2023). Direkte sitat setjast i hermeteikn.',
 eks:'I løpande tekst: (Jensen, 2023) ikkje (Kari Jensen, 2023). Sitat: «…» (Jensen, 2023).'},

{kat:'kjeldebruk',kat_label:'Kjeldebruk',type:'fix',vanske:'medium',
 q:'Rett dei tre kjeldebruksfeila i teksten.',
 tekst:'Forskar Berg skriv: Ungdom bruker i gjennomsnitt seks timar dagleg på skjerm (Berg, 2024, s. 31). Ein rapport frå SSB stadfestar dette (ssb.no, 2023). Statistikken syner store endringar. (SSB, 2021).',
 errors:{'Berg skriv: Ungdom bruker i gjennomsnitt seks timar dagleg på skjerm':'Berg skriv: «Ungdom bruker i gjennomsnitt seks timar dagleg på skjerm»','(ssb.no, 2023)':'(SSB, 2023)','store endringar. (SSB, 2021).':'store endringar (SSB, 2021).'},
 fasit:'Sitat i hermeteikn · (ssb.no, 2023) → (SSB, 2023) · Kjeldetilvising foran punktum',
 regel:'Tre reglar: 1) Direkte sitat krev hermeteikn. 2) Bruk (Institusjon, årstal), ikkje URL. 3) Kjeldetilvising kjem FØR punktum.',
 eks:'«Sitat» (Kjelde, årstal). · (SSB, 2023) ikkje (ssb.no). · ...endringar (SSB, 2021).'},

{kat:'kjeldebruk',kat_label:'Kjeldebruk',type:'fix',vanske:'vanskeleg',
 q:'Rett dei tre kjeldebruksfeila i denne teksten frå ein litterær analyse.',
 tekst:'I novella «Vinterlys» brukar forfattaren naturen som symbol. Hansen (2021) skriv: Naturen spegler karakteren sitt indre liv (s. 45). Vidare argumenterer Hansen, Sara for at symbolbruken skapar djupne i teksten. (Hansen, 2021).',
 errors:{'Hansen (2021) skriv: Naturen spegler karakteren sitt indre liv':'Hansen (2021) skriv: «Naturen spegler karakteren sitt indre liv»','Hansen, Sara':'Hansen','skapar djupne i teksten. (Hansen, 2021).':'skapar djupne i teksten (Hansen, 2021).'},
 fasit:'Sitat i hermeteikn · «Hansen, Sara» → «Hansen» · Kjeldetilvising foran punktum',
 regel:'1) Direkte sitat krev hermeteikn. 2) I løpande tekst brukes berre etternamnet. 3) Kjeldetilvising kjem FØR punktum.',
 eks:'Hansen (2021) skriv: «Tekst» (s. 45). · argumenterer Hansen for · djupne (Hansen, 2021).'},

{kat:'kjeldebruk',kat_label:'Kjeldebruk',type:'fix',vanske:'vanskeleg',
 q:'Rett dei fire kjeldebruksfeila i teksten.',
 tekst:'Demokratiet er avhengig av ei opplyst befolkning. Ifølgje Eriksen, 2022 er mediekritikk viktigare enn nokosinne. Han hevdar: All informasjon bør kjeldekritiski vurderast (Eriksen, 2022, s. 8). Ei undersøking frå Karl Ivar Karlsen syner at 40 prosent av nyheiter ikkje er faktasjekka. (Karlsen, 2023). Det er eit urovekkjande funn.',
 errors:{'Eriksen, 2022 er':'Eriksen (2022) er','Han hevdar: All informasjon bør kjeldekritiski vurderast':'Han hevdar: «All informasjon bør kjeldekritiski vurderast»','Karl Ivar Karlsen':'Karlsen','faktasjekka. (Karlsen, 2023).':'faktasjekka (Karlsen, 2023).'},
 fasit:'Eriksen (2022) · Sitat i hermeteikn · Karl Ivar Karlsen → Karlsen · Kjeldetilvising foran punktum',
 regel:'Fire reglar: 1) Årstal i parentes etter etternamn: Eriksen (2022). 2) Sitat krev hermeteikn. 3) Berre etternamn i løpande tekst. 4) Kjeldetilvising FØR punktum.',
 eks:'Eriksen (2022) meiner · «Sitat» (Kjelde, år) · Karlsen, ikkje fullt namn · ...funn (Karlsen, 2023).'}
...
function mtBuildFixCorrectionHtml(task, missedWrongs) {
  ...
  var html = '<div class="mt-fb-correction">' +
    '<div class="mt-fb-corr-row"><strong>Slik skulle det vere:</strong> ' + mtEscHighlight(corrected, correctedTokens, 'mt-mark-ok') + '</div>';
  ...
  if (missed.length) {
    ...
    html += '<div class="mt-fb-corr-row mt-fb-missed"><strong>Feil du ikkje retta (' + missed.length + '):</strong>' +
      ...
      '<div class="mt-live">' +
        ...
        '<details class="mt-live-mastery-toggle">' +
          ...
          '<div class="mt-live-mastery">' +
            '<div class="mt-live-mastery-head"><span id="mt-live-mastery-trophies">0/12 trofé</span></div>' +
...
function mtIsWritingTask(task) {
  ...
  /* Typar som alltid er skriveoppgåver */
  if (task.type === 'open' || task.type === 'omskriv') return true;
  /* Kategori djupneoppgaver skal alltid handsamast som skriveoppgåver */
...
function mtCheckOpen() {
  ...
  if (mtIsGibberish(val)) {
    ...
    /* Ingen XP for gibberish, men heller ikkje feil – berre bed eleven prøve igjen */
    mtFinish(true, 0, 0, val, t, 'Skriv litt meir, så blir det lettare å gi nyttige skrivetips. Du kan alltid prøve igjen!', true, true);
    return;
  }

  /* Sjekk maa_ha / maa_ikkje_ha (mjuk vegleiing, ikkje feil) */
  ...
  if (missing.length) {
    ...
    extra = 'Neste gong: vurder å byte ut orda «' + forbidden.join('», «') + '» med noko meir presist.';
  ...
  /* Skriveoppgåver skal alltid ha nøytral styling – aldri raud/grøn */
  el.className = 'mt-text-input mt-textarea mt-inp-neutral';

  /* XP-skala basert på lengde og oppgåvespesifikk minimumsord/idealord */
...
function mtCheckFix() {
  ...
  if (!prev || !prev.classList || !prev.classList.contains('mt-fix-userlabel')) {
    var labelHtml = '<p class="mt-fix-userlabel">Teksten din \u2014 <span class="mt-mark-ok">gr\u00f8ne</span> ord er rette rettingar, <span class="mt-mark-bad">raude</span> er feil som st\u00e5r att.</p>';
...
function mtCheckOmskriv() {
  ...
  if (mtIsGibberish(val)) {
    el.className = 'mt-text-input mt-textarea mt-inp-neutral';
    mtFinish(true, 0, 0, val, t, 'Skriv litt meir, så kan du bruke råda til å omskrive teksten tydelegare. Du kan alltid prøve igjen!', true, true);
    return;
  }

  /* Sjekk maa_ha / maa_ikkje_ha (mjuk vegleiing) */
  var lower = val.toLowerCase();
  var missing = [];
  (t.maa_ha || []).forEach(function (kw) {
    if (lower.indexOf(kw.toLowerCase()) === -1) missing.push(kw);
  ...
  else if (forbidden.length) extra = 'Neste gong: vurder å byte ut orda «' + forbidden.join('», «') + '» med noko meir presist.';
...
function mtShowSummary() {
  ...
  if (_timeEl) {
    try { _timeEl.textContent = new Intl.DateTimeFormat('nn-NO', {day:'2-digit',month:'2-digit',year:'numeric',hour:'2-digit',minute:'2-digit'}).format(new Date()); }
  ...
  if (sumEl) {
    ...
    gp.innerHTML = gpHtml;
    /* Sett inn etter styrkar/øvingsråd, rett før aksjonsknappar */
