...
{emne:'verb',emne_label:'Verb – preteritum',type:'multiple_choice',vanske:'medium',
 ...
 alternativer:['skreiv','skreev','skreien','skriv'],
...
{emne:'verb',emne_label:'Verb – preteritum',type:'cloze',vanske:'medium',
 sporsmal:'Skriv «å skrive» i preteritum.',setning:'Dei ___ ein lang brev til kvarandre.',
 fasit:'skreiv',fasit_variant:['skreiv'],
...
{emne:'verb',emne_label:'Verb – perfektum',type:'multiple_choice',vanske:'medium',
 sporsmal:'Kva er rett perfektum partisipp av «å kaste»?',setning:null,
...
{emne:'verb',emne_label:'Verb – perfektum',type:'cloze',vanske:'medium',
 sporsmal:'Perfektum = «har» + fortidsform. Skriv «å arbeide» i perfektum. Eks: Vi har ___ heile dagen.',setning:'Vi har ___ heile dagen.',
...
{emne:'pronomen',emne_label:'Pronomen',type:'multiple_choice',vanske:'vanskeleg',
 sporsmal:'Kva er rett refleksivt pronomen i «Han kjøpte noko til ___»?',setning:null,
...
{emne:'pronomen',emne_label:'Pronomen',type:'cloze',vanske:'vanskeleg',
 sporsmal:'Fyll inn refleksivt pronomen (verbet peikar tilbake på «ho»).',setning:'Ho lagar mat til ___ og familien sin.',
 fasit:'seg',fasit_variant:['seg'],
...
{emne:'adjektiv',emne_label:'Adjektiv – samsvar',type:'multiple_choice',vanske:'medium',
 sporsmal:'Bestemt form = vi legg til «den/det/dei» + adjektiv. Kva er rett: «den store bilen» eller «den stor bil»?',setning:null,
...
{emne:'adjektiv',emne_label:'Adjektiv – gradbøying',type:'multiple_choice',vanske:'vanskeleg',
 sporsmal:'Komparativ = samanlikningsform (betyr «meir»). Kva er komparativ av «lang»? (Lang → ___?)',setning:null,
...
/* ── TYPISKE ORD – sett 1 (20 oppgåver) ── */
...
/* ── TYPISKE ORD – sett 2 (20 oppgåver) ── */
...
/* ── KLIKK-OG-MARKER: ADJEKTIV (3 oppgåver) ── */
{kat:'ordklassar',kat_label:'Klikk og marker – adjektiv',type:'klikk_marker',vanske:'lett',
 q:'Klikk på alle adjektiva i teksten.',
 maalordklasse:'adjektiv',
 tekst:'Den gamle hunden låg roleg i den mjuke senga.',
 fasit_ord:['gamle','roleg','mjuke'],
 regel:'Adjektiv skildrar eigenskapar ved substantiv: gammal hund, mjuk seng.'},

{kat:'ordklassar',kat_label:'Klikk og marker – adjektiv',type:'klikk_marker',vanske:'medium',
 q:'Klikk på alle adjektiva i teksten.',
 maalordklasse:'adjektiv',
 tekst:'Den unge jenta sprang raskt gjennom den tette skogen på ein kald vinterdag.',
 fasit_ord:['unge','raskt','tette','kald'],
 regel:'Adjektiv og adverb kan begge skildre, men adjektiv høyrer til substantiv.'},

{kat:'ordklassar',kat_label:'Klikk og marker – adjektiv',type:'klikk_marker',vanske:'vanskeleg',
 q:'Klikk på alle adjektiva i teksten.',
 maalordklasse:'adjektiv',
 tekst:'Han var tydeleg nervøs og sveitte hender vitna om den vanskelege situasjonen han stod i.',
 fasit_ord:['tydeleg','nervøs','sveitte','vanskelege'],
 regel:'Adjektiv kan stå etter "vere" (predikativt) eller framfor substantiv (attributivt).'},

/* ── KLIKK-OG-MARKER: VERB (3 oppgåver) ── */
{kat:'ordklassar',kat_label:'Klikk og marker – verb',type:'klikk_marker',vanske:'lett',
 q:'Klikk på alle verba i teksten.',
 maalordklasse:'verb',
 tekst:'Ho spring til skulen og møter vennene sine ved porten.',
 fasit_ord:['spring','møter'],
 regel:'Verb uttrykkjer handling eller tilstand. Prøv å setje "å" framfor – "å springe", "å møte".'},

{kat:'ordklassar',kat_label:'Klikk og marker – verb',type:'klikk_marker',vanske:'medium',
 q:'Klikk på alle verba i teksten.',
 maalordklasse:'verb',
 tekst:'Katten sat på taket og stirra ned på fuglen som flaug forbi.',
 fasit_ord:['sat','stirra','flaug'],
 regel:'Finitt verb (bøygd i tid) og infinitiv tel. Her: preteritum av sitte, stirre, flyge.'},

{kat:'ordklassar',kat_label:'Klikk og marker – verb',type:'klikk_marker',vanske:'vanskeleg',
 q:'Klikk på alle verba (inkl. hjelpeverb) i teksten.',
 maalordklasse:'verb',
 tekst:'Ho har skrive ein lang tekst og kjem til å levere han i morgon.',
 fasit_ord:['har','skrive','kjem','levere'],
 regel:'Hjelpeverb (har, kjem til å) og hovudverb (skrive, levere) er begge verb.'},

/* ── KLIKK-OG-MARKER: SUBSTANTIV (3 oppgåver) ── */
{kat:'ordklassar',kat_label:'Klikk og marker – substantiv',type:'klikk_marker',vanske:'lett',
 q:'Klikk på alle substantiva i teksten.',
 maalordklasse:'substantiv',
 tekst:'Hunden og katten slost om ballen i stova.',
 fasit_ord:['hunden','katten','ballen','stova'],
 regel:'Substantiv er namn på ting, personar eller stader. Dei har ofte artikkelen ein/ei/eit framfor.'},

{kat:'ordklassar',kat_label:'Klikk og marker – substantiv',type:'klikk_marker',vanske:'medium',
 q:'Klikk på alle substantiva i teksten.',
 maalordklasse:'substantiv',
 tekst:'Læraren skreiv eit langt brev til foreldra om fridagen.',
 fasit_ord:['læraren','brev','foreldra','fridagen'],
 regel:'Substantiv: læraren (person), brev (ting), foreldra (personar), fridagen (tid/hendelse).'},

{kat:'ordklassar',kat_label:'Klikk og marker – substantiv',type:'klikk_marker',vanske:'vanskeleg',
 q:'Klikk på alle substantiva (inkl. abstrakte) i teksten.',
 maalordklasse:'substantiv',
 tekst:'Fridomen er ein viktig verdi i eit demokratisk samfunn.',
 fasit_ord:['fridomen','verdi','samfunn'],
 regel:'Abstrakte substantiv (fridom, verdi) er substantiv sjølv om dei ikkje er fysiske ting.'},


/* ── FINN FEILA – Korrekturlesaren (blanda, 3 oppgåver) ── */
{kat:'blanda',kat_label:'Finn feila',type:'finn_feil',vanske:'medium',
 q:'Det er 5 feil i teksten. Finn og klikk på alle.',
 tekst:'Eg og vennane mine spilte fotball i går. Vi vant med tree mål til to. Etterpå spiste vi pizza og det var veldig godt. Alle var trøytte etter kampen og ville dra heim.',
 fasit_feil:['spilte','vant','tree','spiste','trøytte'],
 regel:'Feil: spilte→spelte, vant→vann, tree→tre, spiste→åt, trøytte→tøytte→trøytte (nynorsk: trøytte er rett; men spilte/vant/tree/spiste er bokmål/feil).'},

{kat:'blanda',kat_label:'Finn feila',type:'finn_feil',vanske:'medium',
 q:'Det er 4 grammatiske feil i teksten. Finn og klikk på dei.',
 tekst:'Ho likte å og lese bøker om historien. Bøkene var tykke og full av kunnskap. Ho leste alltid på kveledane når hu hadde tid.',
 fasit_feil:['og','full','kveledane','hu'],
 regel:'og→(fjern "og"), full→fulle (fleirtal), kveledane→kveldane, hu→ho (nynorsk).'},

{kat:'blanda',kat_label:'Finn feila',type:'finn_feil',vanske:'vanskeleg',
 q:'Det er 5 feil i teksten. Finn og klikk på dei.',
 tekst:'Elevene jobbet hardt med oppgaven sin. Læreren gadd dem god tilbakemelding og forklarte hva de hadde gjort galt. Noen synes det var vansklig, men de prøvde igjen.',
 fasit_feil:['elevene','oppgaven','gadd','hva','vansklig'],
 regel:'elevene→elevane, oppgaven→oppgåva, gadd→gav, hva→kva, vansklig→vanskeleg (nynorsk og rettskriving).'},
